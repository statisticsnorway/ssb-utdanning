...
class TestUtdKatalog(unittest.TestCase):
    ...
    def test_init(self):
        katalog = UtdKatalog(key_cols='ident',
                             path=self.katalog_path)
        self.assertIsInstance(katalog, UtdKatalog)
        self.assertIsInstance(katalog.key_cols, list)
        
        with self.assertRaises(TypeError):
            katalog = UtdKatalog(key_cols=['ident', 123],
                                 path=self.katalog_path)
    ...
    def test_merge_on(self):
        ...
        result=katalog.merge_on(dataset = data,
                                key_col_in_data = 'ident')
    ...
    def test_apply_format(self):
        ...
        katalog.apply_format(data.data,
